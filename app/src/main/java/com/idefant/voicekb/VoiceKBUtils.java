...
public class VoiceKBUtils {
    ...
    public static void applyApplicationLocale(Context context) {
        SharedPreferences sp = context.getSharedPreferences("com.idefant.voicekb", Context.MODE_PRIVATE);
        String language = sp.getString("com.idefant.voicekb.app_language", "system");
    ...
    public static String getTranscriptionProviderName(Context context, SharedPreferences sp) {
        int provider = sp.getInt("com.idefant.voicekb.transcription_provider", 1);
        switch (provider) {
            case 0:
                return "OpenAI";
            case 1:
                return "Groq";
            case 2:
                return context.getString(R.string.voicekb_custom_provider);
            default:
                return context.getString(R.string.voicekb_transcription_provider);
        }
    }

    public static boolean isOpenAITranscriptionProvider(SharedPreferences sp) {
        return sp.getInt("com.idefant.voicekb.transcription_provider", 1) == 0;
    }
    ...
    public static void applyProxy(OpenAIOkHttpClient.Builder clientBuilder, SharedPreferences sp) {
        String proxyInput = sp.getString("com.idefant.voicekb.proxy_host", "");
        boolean proxyEnabled = sp.getBoolean("com.idefant.voicekb.proxy_enabled", false);
