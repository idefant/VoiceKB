...
public class UsageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalCostTv.setText(getString(R.string.voicekb_usage_total_cost, db.getTotalCost()));
        ...
        resetUsageBtn.setOnClickListener(v -> new MaterialAlertDialogBuilder(this)
                .setTitle(R.string.voicekb_usage_reset_usage_title)
                .setMessage(R.string.voicekb_usage_reset_usage_message)
