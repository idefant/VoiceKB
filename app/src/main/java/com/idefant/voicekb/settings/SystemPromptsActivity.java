...
public class SystemPromptsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(R.string.voicekb_transcription_style_prompt_title);
        }
        ...
        ImageView helpButton = findViewById(R.id.transcription_style_prompt_help_iv);

        changeTranscriptionSelection(sp.getInt("com.idefant.voicekb.style_prompt_selection", 1));
        transcriptionStylePromptCustomEt.setText(sp.getString("com.idefant.voicekb.style_prompt_custom_text", ""));
        ...
        transcriptionStylePromptCustomEt.addTextChangedListener(new SimpleTextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                sp.edit().putString("com.idefant.voicekb.style_prompt_custom_text", s.toString()).apply();
            }
        });
        helpButton.setOnClickListener(v -> startActivity(new Intent(Intent.ACTION_VIEW,
                Uri.parse("https://platform.openai.com/docs/guides/speech-to-text#prompting"))));
    }
    ...
    private void changeTranscriptionSelection(int selection) {
        ...
        sp.edit().putInt("com.idefant.voicekb.style_prompt_selection", selection).apply();
    }
