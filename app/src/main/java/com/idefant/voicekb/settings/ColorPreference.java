...
public class ColorPreference extends Preference {
    ...
    protected void onClick() {
        ...
        ColorPickerDialogBuilder.with(getContext())
                .setTitle(getContext().getString(R.string.voicekb_settings_accent_color))
                .initialColor(colorValue)
                .wheelType(ColorPickerView.WHEEL_TYPE.FLOWER)
                .density(9)
                .setPositiveButton(getContext().getString(R.string.voicekb_okay), (dialog, selectedColor, allColors) -> {
                ...
                .setNegativeButton(getContext().getString(R.string.voicekb_cancel), (dialog, which) -> {})
                .build()
                .show();
    }
    ...
    private void updateSummary() {
        String summaryText = getContext().getString(R.string.voicekb_settings_accent_color_summary);
        String highlight = getContext().getString(R.string.voicekb_settings_accent_color_word);
